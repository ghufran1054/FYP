...
def main():
    ...
    testloader = THUMOSDatasetFLOW(cfg_mroad, mode='test', rootpath='/data1/ghufran/test_flow_farn')
    print('testloader', len(testloader))
    trainloader = THUMOSDatasetFLOW(cfg_mroad, mode='train', rootpath='/data1/ghufran/validation_flow_farn')
